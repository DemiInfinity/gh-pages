        ...
        <div className={styles.pageContainer}>
          <div className={styles.projectsSection}>
            ...
            <p className={styles.subtitle}>
              Explore the diverse range of projects I've crafted using modern
              web technologies. From full-stack applications to creative
              solutions, each project reflects my commitment to innovation and
              user-centric design.
            </p>
