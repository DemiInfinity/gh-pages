    ...
    <div className="pageContainer">
      <div className="textContainer md:pl-40 md:pb-20">
        ...
        <p className="textHome">
          I’m Demi Taylor Nimmo, a passionate full-stack developer dedicated to
          bringing creativity and functionality together. With expertise in
        ...
        <p className="textProjects">
          I’m currently working on some exciting projects. If you're interested
          in exploring more or gaining detailed insights, simply head to the
          Projects page in the navigation bar below.
        </p>
